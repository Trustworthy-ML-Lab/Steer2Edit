...
def main():
    ...
    parser.add_argument("--main_title", type=str, default="Edit Component Distribution: Truthfulness")
    ...
    parser.add_argument("--model1", type=str, default="gemma2-2b")
    parser.add_argument("--title1", type=str, default="Gemma-2-2B-IT")
    parser.add_argument("--ra1", type=float, default=0.3)
    parser.add_argument("--rm1", type=float, default=-1.0)
    parser.add_argument("--a1", type=float, default=0.9)
    
    parser.add_argument("--model2", type=str, default="llama3-8b")
    parser.add_argument("--title2", type=str, default="LLaMA-3-8B-Instruct")
    parser.add_argument("--ra2", type=float, default=0.1)
    parser.add_argument("--rm2", type=float, default=0.3)
    parser.add_argument("--a2", type=float, default=0.4)

    parser.add_argument("--save_root", type=str, default="edited_models")
    parser.add_argument("--output_dir", type=str, default=".")
    parser.add_argument("--filename", type=str, default="edit_distribution_truth", help="Output filename prefix")
