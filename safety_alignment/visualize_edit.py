...
def main():
    ...
    parser.add_argument("--main_title", type=str, default="Edit Component Distribution: Safety Alignment")
    ...
    parser.add_argument("--model1", type=str, default="llama2-7b")
    parser.add_argument("--title1", type=str, default="LLaMA-2-7B-Chat")
    parser.add_argument("--ra1", type=float, default=0.18)
    parser.add_argument("--rm1", type=float, default=0.55)
    parser.add_argument("--a1", type=float, default=0.8)
    
    parser.add_argument("--model2", type=str, default="mistral-7b")
    parser.add_argument("--title2", type=str, default="Mistral-7B-Instruct-v0.2")
    parser.add_argument("--ra2", type=float, default=0.42)
    parser.add_argument("--rm2", type=float, default=0.55)
    parser.add_argument("--a2", type=float, default=0.75)

    parser.add_argument("--save_root", type=str, default="edited_models")
    parser.add_argument("--output_dir", type=str, default=".")
    parser.add_argument("--filename", type=str, default="edit_distribution_safety", help="Output filename prefix")
